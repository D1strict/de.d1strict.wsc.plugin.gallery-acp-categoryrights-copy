<?php
namespace gallery\acp\form;
use gallery\data\category\GalleryCategoryNodeTree;
...
class CategoryRightsCopyForm extends AbstractForm  {
	 ...
	 */
	public $activeMenuItem = 'gallery.acp.menu.link.gallery.category.rights.copy';

	/**
	 * @see	\wcf\page\AbstractPage::$neededPermissions
	 */
	public $neededPermissions = array('admin.gallery.canManageCategory');
	...
	public function readParameters() {
		...
		$this->objectTypeID = ACLHandler::getInstance()->getObjectTypeID('com.woltlab.gallery.category');
	}
	...
	public function assignVariables() {
		...
		$categoryTree = new galleryCategoryNodeTree('com.woltlab.gallery.category', 0, true, array());
